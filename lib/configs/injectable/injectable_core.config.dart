...
import '../../modules/auth/blocs/login/login_bloc.dart' as _i33;
import '../../modules/auth/blocs/register/register_bloc.dart' as _i36;
...
import '../../modules/profile/blocs/profile/profile_bloc.dart' as _i35;
...
import '../../modules/report/blocs/my_report/my_report_bloc.dart' as _i34;
import '../../modules/report/blocs/report/report_bloc.dart' as _i24;
import '../../modules/report/blocs/report_form/report_form_bloc.dart' as _i37;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i31.FeatureBloc>(() =>
      _i31.FeatureBloc(homeRepository: get<_i12.HomeProviderInterface>()));
  gh.factory<_i32.GeolocationBloc>(() => _i32.GeolocationBloc(
  ...
  gh.factory<_i34.MyReportBloc>(
      () => _i34.MyReportBloc(get<_i27.ReportRepositoryInterface>()));
  ...
  gh.factory<_i36.RegisterBloc>(() => _i36.RegisterBloc(
      registerRepository: get<_i22.RegisterRepositoryInterface>(),
      authRepository: get<_i3.AuthRepositoryInterface>()));
  gh.factory<_i37.ReportFormBloc>(() => _i37.ReportFormBloc(
      reportRepository: get<_i27.ReportRepositoryInterface>(),
      authRepository: get<_i3.AuthRepositoryInterface>()));
  return get;
}

class _$NativeApiService extends _i38.NativeApiService {}
