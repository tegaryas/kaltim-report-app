...
import '../../core/bloc/auth_bloc.dart' as _i31;
...
import '../../modules/auth/repositories/register_repository_interface.dart'
    as _i22;
import '../../modules/call/blocs/calls/call_bloc.dart' as _i32;
...
import '../../modules/profile/blocs/edit_profile/edit_profile_bloc.dart'
    as _i33;
import '../../modules/profile/blocs/profile/profile_bloc.dart' as _i38;
...
import '../../modules/report/blocs/my_report/my_report_bloc.dart' as _i37;
import '../../modules/report/blocs/report/report_bloc.dart' as _i24;
import '../../modules/report/blocs/report_form/report_form_bloc.dart' as _i40;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i30.UpdatePasswordBloc>(() => _i30.UpdatePasswordBloc(
      profileRepository: get<_i20.ProfileRepositoryInterface>()));
  gh.singleton<_i31.AuthBloc>(
      _i31.AuthBloc(authRepository: get<_i3.AuthRepositoryInterface>()));
  gh.factory<_i32.CallBloc>(
      () => _i32.CallBloc(callRepository: get<_i7.CallRepositoryInterface>()));
  gh.factory<_i33.EditProfileBloc>(() => _i33.EditProfileBloc(
      profileRepository: get<_i20.ProfileRepositoryInterface>()));
  ...
  gh.factory<_i36.LoginBloc>(() => _i36.LoginBloc(
      ...
      registerRepository: get<_i22.RegisterRepositoryInterface>()));
  gh.factory<_i37.MyReportBloc>(
      () => _i37.MyReportBloc(get<_i27.ReportRepositoryInterface>()));
  gh.factory<_i38.ProfileBloc>(() => _i38.ProfileBloc(
      profileRepository: get<_i20.ProfileRepositoryInterface>()));
  gh.factory<_i39.RegisterBloc>(() => _i39.RegisterBloc(
      registerRepository: get<_i22.RegisterRepositoryInterface>(),
      authRepository: get<_i3.AuthRepositoryInterface>()));
  gh.factory<_i40.ReportFormBloc>(() => _i40.ReportFormBloc(
      reportRepository: get<_i27.ReportRepositoryInterface>(),
      authRepository: get<_i3.AuthRepositoryInterface>()));
  return get;
}

class _$NativeApiService extends _i41.NativeApiService {}
