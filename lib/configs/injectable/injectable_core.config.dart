...
import '../../modules/auth/blocs/register/register_bloc.dart' as _i35;
...
import '../../modules/profile/blocs/profile/profile_bloc.dart' as _i34;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i35.RegisterBloc>(() => _i35.RegisterBloc(
      registerRepository: get<_i22.RegisterRepositoryInterface>(),
      authRepository: get<_i3.AuthRepositoryInterface>()));
  gh.factory<_i36.ReportFormBloc>(() => _i36.ReportFormBloc(
      reportRepository: get<_i27.ReportRepositoryInterface>(),
      authRepository: get<_i3.AuthRepositoryInterface>()));
  return get;
}

class _$NativeApiService extends _i37.NativeApiService {}
