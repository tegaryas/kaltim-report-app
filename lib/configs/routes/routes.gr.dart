...
import '../../modules/call/screens/call_screen.dart' as _i21;
import '../../modules/home/screens/home_screen.dart' as _i19;
...
import '../../modules/news/screens/news_screen.dart' as _i20;
import '../../modules/onboard/screens/onboarding_page.dart' as _i2;
import '../../modules/profile/models/profile_model.dart' as _i27;
...
import '../../modules/profile/screens/profile_screen.dart' as _i22;
import '../../modules/report/models/report_model.dart' as _i25;
...
class AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    HomeRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i19.HomeScreen());
    },
    NewsRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i20.NewsScreen());
    },
    CallRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i21.CallScreen());
    },
  ...
  List<_i23.RouteConfig> get routes => [
        _i23.RouteConfig(SplashRoute.name, path: '/splash-screen'),
        _i23.RouteConfig(OnboardingRoute.name, path: '/onboarding'),
        _i23.RouteConfig(LoginRoute.name, path: '/login'),
        _i23.RouteConfig(RegisterRoute.name, path: '/register'),
        _i23.RouteConfig(RegisterUserDataRoute.name, path: '/register-data'),
        _i23.RouteConfig(ResetPasswordRoute.name, path: '/reset-password'),
        _i23.RouteConfig(ReportRouter.name, path: 'report', children: [
          _i23.RouteConfig(ReportRoute.name,
        ...
        _i23.RouteConfig(NewsDetailRoute.name, path: '/news-detail'),
        _i23.RouteConfig(AddReportRoute.name, path: '/add-report'),
        _i23.RouteConfig(DetailReportRoute.name, path: '/detail-report'),
        _i23.RouteConfig(ReportLocationRoute.name, path: '/location-maps'),
        _i23.RouteConfig(MyReportRoute.name, path: '/my-report'),
        _i23.RouteConfig(EditProfileRoute.name, path: '/edit-profile'),
        _i23.RouteConfig(DetailProfileRoute.name, path: '/detail-profile'),
        _i23.RouteConfig(ChangePasswordRoute.name, path: '/change-password'),
        _i23.RouteConfig(AboutRoute.name, path: '/about-app'),
        _i23.RouteConfig(NavigationRoute.name, path: '/menu', children: [
          _i23.RouteConfig(HomeRoute.name,
              path: 'home', parent: NavigationRoute.name),
          _i23.RouteConfig(NewsRoute.name,
              path: 'news', parent: NavigationRoute.name),
          _i23.RouteConfig(CallRoute.name,
...
class RegisterUserDataRoute
    extends _i23.PageRouteInfo<RegisterUserDataRouteArgs> {
  RegisterUserDataRoute({_i24.Key? key, required String email})
...
class ReportRouter extends _i23.PageRouteInfo<void> {
  const ReportRouter({List<_i23.PageRouteInfo>? children})
...
class NewsDetailRoute extends _i23.PageRouteInfo<NewsDetailRouteArgs> {
  NewsDetailRoute({_i24.Key? key, required String newsUrl})
...
/// generated route for
/// [_i9.AddReportScreen]
class AddReportRoute extends _i23.PageRouteInfo<AddReportRouteArgs> {
  AddReportRoute({_i24.Key? key, String? reportTitle})
...
class DetailReportRoute extends _i23.PageRouteInfo<DetailReportRouteArgs> {
  DetailReportRoute({_i24.Key? key, required _i25.ReportModel report})
...
class ReportLocationRoute extends _i23.PageRouteInfo<ReportLocationRouteArgs> {
  ReportLocationRoute({_i24.Key? key, required _i26.LatLng latLng})
...
/// generated route for
/// [_i12.MyReportScreen]
class MyReportRoute extends _i23.PageRouteInfo<void> {
...
class EditProfileRoute extends _i23.PageRouteInfo<EditProfileRouteArgs> {
  EditProfileRoute({_i24.Key? key, required _i27.ProfileModel profile})
...
class EditProfileRouteArgs {
  ...
  final _i27.ProfileModel profile;
...
class DetailProfileRoute extends _i23.PageRouteInfo<void> {
